package com.mx.lsp.app.item.controllers;
...
import com.mx.lsp.app.item.models.service.ItemService;
...
public class ItemController {
	...
	public ResponseEntity<?> obtenerConfig(@Value("${server.port}") String puerto) {
		...
		return new ResponseEntity<Map<String, String>>(json, org.springframework.http.HttpStatus.OK);
	}
